...
import { AppsMenu } from "@cornfield_theme/webclient/appsmenu/appsmenu";
import { AppsBar } from "@cornfield_theme/webclient/appsbar/appsbar";
import { SwitchCompanyMenu } from "@web/webclient/switch_company_menu/switch_company_menu";
import { UserMenu } from "@web/webclient/user_menu/user_menu";

patch(NavBar.prototype, "cornfield_theme.NavBar", {
    setup() {
        this._super();
...
patch(NavBar, "cornfield_theme.NavBar", {
    components: {
        ...NavBar.components,
        AppsMenu,
        AppsBar,
